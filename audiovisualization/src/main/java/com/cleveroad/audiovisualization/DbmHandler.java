...
public abstract class DbmHandler<TData> {
    ...
    private static final long UPDATE_INTERVAL = 16;//更新间隔
    private int layersCount;
    private InnerAudioVisualization audioVisualization;
    private float[] dBmArray;//分贝
    private float[] ampsArray;//振幅
    ...
    /**
     * Call this method when your data is available for conversion.//转换、转变
     * @param data any data
     */
    ...
    /**
     * Implement your own data conversion.//实施数据转化
     * @param data any data
